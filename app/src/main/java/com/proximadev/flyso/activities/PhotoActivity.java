...
public class PhotoActivity extends AppCompatActivity{
    ...
    private String mPhotoUrl, mPhotoName;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.share_image:
                ...
                shareIntent.putExtra(Intent.EXTRA_TEXT, mPhotoUrl);
            ...
            case R.id.copy_url_image:
                try {
                    ...
                    ClipData clip = ClipData.newUri(getContentResolver(), "FlySo-Shared Link:", Uri.parse(mPhotoUrl));
    ...
    private void getPhoto(){
        try{
            ...
            request.setDestinationInExternalPublicDir("FlySo",mPhotoName);
    ...
    public void onDestroy() {
        super.onDestroy();
        try{
            File PictureDir = getExternalCacheDir();
            File FlySoTemp = new File(PictureDir, "FlySoTemp");
            deleteRecursive(FlySoTemp);
        } catch (Exception ex){
            ex.printStackTrace();
        }
    }
