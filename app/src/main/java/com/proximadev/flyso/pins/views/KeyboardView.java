package com.proximadev.flyso.pins.views;
...
import com.proximadev.flyso.pins.interfaces.KeyboardButtonClickedListener;
...
public class KeyboardView extends LinearLayout implements View.OnClickListener {
    ...
    private void initKeyboardButtons(KeyboardView view) {
        ...
        mButtons.add(view.findViewById(R.id.pin_code_button_0));
        mButtons.add(view.findViewById(R.id.pin_code_button_1));
        mButtons.add(view.findViewById(R.id.pin_code_button_2));
        mButtons.add(view.findViewById(R.id.pin_code_button_3));
        mButtons.add(view.findViewById(R.id.pin_code_button_4));
        mButtons.add(view.findViewById(R.id.pin_code_button_5));
        mButtons.add(view.findViewById(R.id.pin_code_button_6));
        mButtons.add(view.findViewById(R.id.pin_code_button_7));
        mButtons.add(view.findViewById(R.id.pin_code_button_8));
        mButtons.add(view.findViewById(R.id.pin_code_button_9));
        mButtons.add(view.findViewById(R.id.pin_code_button_clear));
